...
#+attr_guitar: :container row
#+begin_src lisp
(guitar:diagram (:title "A minor arpeggio" :frets 5 :start 4 :indicator 5)
...
(guitar:diagram (:title "D minor arpeggio" :frets 5 :start 4 :indicator 5)
  (6 5 "5")
...
(guitar:diagram (:title "E major arpeggio" :frets 5 :start 4 :indicator 5)
  (6 4 "3")
  (6 7 "5")
...
#+begin_src lisp
(guitar:diagram (:title "A minor pentatonic" :frets 4 :start 5 :indicator 5)
  (6 5 "R" (:filled :highlight))
  (6 8 "b3")
  (5 5 "4")
  (5 7 "5")
...
#+attr_guitar: :container small
#+begin_src lisp
(guitar:diagram (:title "A natural minor" :frets 5 :start 4 :indicator 5)
  (6 5 "R" (:filled :highlight))
  (6 7 "2" (:stroked :new))
  (6 8 "b3")
  (5 5 "4")
...
#+attr_guitar: :container row
#+begin_src lisp
(guitar:diagram (:title "A minor triad" :frets 5 :start 4 :indicator 5)
  (6 5 "" (:stroked :ref))
  (6 7 "" (:stroked :ref))
  (6 8 "" (:stroked :ref))
  (5 5 "" (:stroked :ref))
...
(guitar:diagram (:title "D minor triad" :frets 5 :start 4 :indicator 5)
  (6 5 "" (:stroked :ref))
  (6 7 "" (:stroked :ref))
  (6 8 "" (:stroked :ref))
  (5 5 "" (:stroked :ref))
...
(guitar:diagram (:title "E major triad" :frets 5 :start 4 :indicator 5)
  (6 5 "" (:stroked :ref))
  (6 7 "" (:stroked :ref))
  (6 8 "" (:stroked :ref))
  (5 5 "" (:stroked :ref))
